...
/**
 * Test values for the &quot;Advanced Encryption Standard&quot; (AES).
 * These values are part of &quot;Federal Information Processing Standards
 * Publication 197&quot;.
 *
 * @author Timm Knape
...
public class Aes256Test {
   ...
   * The results will be compared against the reference values.
   */
  @Test
  public void shouldEntryptAndDecryptATestMessage() {
    ...
    byte[] expectedEncrypted = {
      (byte) 0x8e, (byte) 0xa2, (byte) 0xb7, (byte) 0xca, (byte) 0x51,
      (byte) 0x67, (byte) 0x45, (byte) 0xbf, (byte) 0xea, (byte) 0xfc,
      (byte) 0x49, (byte) 0x90, (byte) 0x4b, (byte) 0x49, (byte) 0x60,
      (byte) 0x89
    };
  ...
  /**
   * Test the encryption and decryption with random data.
   * The key and the data will be random <code>byte</code>s.
   * RANDOM_TRIES iterations will be performed.
   */
  @Test
