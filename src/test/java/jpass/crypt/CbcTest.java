...
/**
 * Unit test for the CBC encryption.
 * The test data will be encrypted and decrypted.
...
public class CbcTest {
  /**
   * Size of the first random message in <code>byte</code>s.
   * Successive random messages will double their size until
  ...
  public void shouldEncryptAndDecryptABigMessage() throws DecryptException, IOException {
    ...
    for (int i = 0; i < 1000; ++i) { _encrypt.encrypt(source); }
    _encrypt.finishEncryption();
  ...
  /**
   * Test reference data.
   * The refernce data was optained by openssl (version 0.9.71)
   */
  @Test
  public void shouldWorkWithReferenceData() throws DecryptException, IOException {
    byte[] iv = {
      (byte) 0x51, (byte) 0xA0, (byte) 0xC6, (byte) 0x19, (byte) 0x67,
      (byte) 0xB0, (byte) 0xE0, (byte) 0xE5, (byte) 0xCF, (byte) 0x46,
      (byte) 0xB4, (byte) 0xD1, (byte) 0x4C, (byte) 0x83, (byte) 0x4C,
      (byte) 0x38
    };

    byte[] key = {
      (byte) 0x97, (byte) 0x6D, (byte) 0x71, (byte) 0x64, (byte) 0xE6,
      (byte) 0xE3, (byte) 0xB7, (byte) 0xAA, (byte) 0xB5, (byte) 0x30,
      (byte) 0xDD, (byte) 0x52, (byte) 0xE7, (byte) 0x29, (byte) 0x19,
      (byte) 0x3A, (byte) 0xD7, (byte) 0xE7, (byte) 0xDF, (byte) 0xD7,
      (byte) 0x61, (byte) 0xF1, (byte) 0x86, (byte) 0xA4, (byte) 0x4B,
      (byte) 0xB7, (byte) 0xFA, (byte) 0xDF, (byte) 0x15, (byte) 0x44,
      (byte) 0x14, (byte) 0x31
    };
    ...
    byte[] expected = {
      (byte) 0x33, (byte) 0xd7, (byte) 0x0a, (byte) 0x5a, (byte) 0xb7,
      (byte) 0xfe, (byte) 0xcf, (byte) 0x92, (byte) 0x4f, (byte) 0x39,
      (byte) 0x70, (byte) 0x83, (byte) 0xd0, (byte) 0xfc, (byte) 0xfe,
      (byte) 0x3a
    };
